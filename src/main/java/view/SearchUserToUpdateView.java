 ...
 */
public class SearchUserToUpdateView extends javax.swing.JFrame {

    /**
     * Creates new form searchUserToUpdate
     */
    public SearchUserToUpdateView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setBounds(230, 70, 470, 50);
        ...
        jPanel1.add(jLabel5);
        jLabel5.setBounds(270, 220, 186, 70);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchUserToUpdateView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchUserToUpdateView().setVisible(true);
            }
        });
    }
